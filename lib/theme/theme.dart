...
TextTheme getTextTheme(TextTheme theme) {
  ...
  return theme.copyWith(
    display4: GoogleFonts.zillaSlab(
        fontSize: 96,
        fontWeight: FontWeight.w300,
        letterSpacing: -1.5,
        color: baseTextColor),
    display3: GoogleFonts.zillaSlab(
        fontSize: 60,
        fontWeight: FontWeight.w300,
        letterSpacing: -0.5,
        color: baseTextColor),
    display2: GoogleFonts.zillaSlab(
        fontSize: 48, fontWeight: FontWeight.w400, color: baseTextColor),
    display1: GoogleFonts.zillaSlab(
        fontSize: 34,
        fontWeight: FontWeight.w400,
        letterSpacing: 0.25,
        color: baseTextColor),
    headline: GoogleFonts.zillaSlab(
        fontSize: 24, fontWeight: FontWeight.w400, color: baseTextColor),
    title: GoogleFonts.zillaSlab(
        fontSize: 25,
        fontWeight: FontWeight.w500,
        letterSpacing: 0.52,
        color: Colors.white),
    subhead: GoogleFonts.zillaSlab(
        fontSize: 16,
        fontWeight: FontWeight.w400,
        letterSpacing: 0.15,
        color: baseTextColor),
    subtitle: GoogleFonts.zillaSlab(
        fontSize: 14,
        fontWeight: FontWeight.w500,
        letterSpacing: 0.1,
        color: baseTextColor),
    body1: GoogleFonts.zillaSlab(
        fontSize: 16,
        fontWeight: FontWeight.w400,
        letterSpacing: 0.5,
        color: baseTextColor),
    body2: GoogleFonts.zillaSlab(
        fontSize: 14,
        fontWeight: FontWeight.w400,
        letterSpacing: 0.25,
        color: baseTextColor),
    button: GoogleFonts.zillaSlab(
        fontSize: 14,
        fontWeight: FontWeight.w500,
        letterSpacing: 1.25,
        color: baseTextColor),
    caption: GoogleFonts.zillaSlab(
        ...
        letterSpacing: 0.4,
        color: baseTextColor),
    overline: GoogleFonts.zillaSlab(
        fontSize: 10,
        fontWeight: FontWeight.w400,
        letterSpacing: 1.5,
        color: baseTextColor),
