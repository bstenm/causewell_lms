...
import 'package:causewell/ui/bloc/profile/profile_bloc.dart';
import 'package:causewell/ui/bloc/profile/profile_event.dart';
    ...
    return Scaffold(
        appBar: AppBar(
          iconTheme: IconThemeData(
            color: Color(0xFFF1595C), //change your color here
          ),
          ...
          title: Text(
            ...
            textScaleFactor: 1.0,
            style: TextStyle(color: Color(0xFFF1595C), fontSize: 20),
          ),
        ),
        body: BlocListener(
          bloc: _bloc,
