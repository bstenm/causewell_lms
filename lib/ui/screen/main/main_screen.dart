...
import 'package:causewell/ui/screen/courses/courses_screen.dart';
import 'package:causewell/ui/screen/favorites/favorites_screen.dart';
import 'package:causewell/ui/screen/home/home_screen.dart';
import 'package:causewell/ui/screen/home_simple/home_simple_screen.dart';
import 'package:causewell/ui/screen/profile/profile_screen.dart';
import 'package:causewell/ui/screen/search/search_screen.dart';
...
class MainScreenArgs {
  ...
  MainScreenArgs(this.optionsBean, {this.selectedIndex = 0});
}
...
class MainScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MainScreenWidget(args.optionsBean, args.selectedIndex);
  }
}
...
class MainScreenWidget extends StatefulWidget {
  ...
  MainScreenWidget(this.optionsBean, this.selectedIndex) : super();
...
//   final _unselectedBgColor = mainColor;
  ...
  @override
  Widget build(BuildContext context) {
    _selectedIndex = _fromMenu ? _selectedIndex : widget.selectedIndex;
